...
from ...models.tunnel_config_request import TunnelConfigRequest
    ...
    *, client: Client, response: httpx.Response
    ...
    if response.status_code == 200:
        try:
            ...
            return None
        response_200 = SuccessResponse.from_dict(_response_content)
    ...
    if response.status_code == 500:
        try:
            ...
            return None
        response_500 = ErrorResponse.from_dict(_response_content)
...
def sync_detailed(
    *,
    ...
    """Update tunnel configuration
     ...
     Apply a new tunnel configuration on the fly. The existing tunnel is torn down and a new one is
    established. This endpoint is write-only; there is no corresponding GET to read the config back.
