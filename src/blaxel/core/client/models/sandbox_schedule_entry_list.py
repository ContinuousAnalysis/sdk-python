...
T = TypeVar("T", bound="SandboxScheduleEntryList")


@_attrs_define
class SandboxScheduleEntryList:
    """Cursor-paginated list of a sandbox's schedule definitions.

    Attributes:
        data (Union[Unset, list['SandboxScheduleEntry']]): Page of schedule definitions.
    ...
    data: Union[Unset, list["SandboxScheduleEntry"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T | None:
        ...
        for data_item_data in _data or []:
            data_item = SandboxScheduleEntry.from_dict(data_item_data)
        ...
        sandbox_schedule_entry_list = cls(
            data=data,
            meta=meta,
        )

        sandbox_schedule_entry_list.additional_properties = d
        return sandbox_schedule_entry_list
