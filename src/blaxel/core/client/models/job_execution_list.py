...
T = TypeVar("T", bound="JobExecutionList")


@_attrs_define
class JobExecutionList:
    """Cursor-paginated list of job executions. Returned starting with API version 2026-04-28; older API versions keep the
    legacy offset-based contract and return a bare array.

        Attributes:
            data (Union[Unset, list['JobExecution']]): Page of job executions.
    ...
    data: Union[Unset, list["JobExecution"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any] | list[Any]) -> T | None:
        ...
        for data_item_data in _data or []:
            data_item = JobExecution.from_dict(data_item_data)
