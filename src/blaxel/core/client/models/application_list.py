...
class ApplicationList:
    """Cursor-paginated list of applications. Returned starting with API version 2026-04-28; older API versions return a
    bare array of applications instead.

        Attributes:
            data (Union[Unset, list['Application']]): Page of applications.
    ...
    data: Union[Unset, list["Application"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T | None:
        ...
        for data_item_data in _data or []:
            data_item = Application.from_dict(data_item_data)
