...
T = TypeVar("T", bound="FunctionList")


@_attrs_define
class FunctionList:
    """Cursor-paginated list of MCP server functions. Returned starting with API version 2026-04-28; older API versions
    return a bare array.

        Attributes:
            data (Union[Unset, list['Function']]): Page of functions.
    ...
    data: Union[Unset, list["Function"]] = UNSET
