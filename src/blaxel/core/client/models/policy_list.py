...
@_attrs_define
class PolicyList:
    """Cursor-paginated list of policies. Returned starting with API version 2026-04-28; older API versions return a bare
    array.

        Attributes:
            data (Union[Unset, list['Policy']]): Page of policies.
    ...
    data: Union[Unset, list["Policy"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any] | list[Any]) -> T | None:
        ...
        for data_item_data in _data or []:
            data_item = Policy.from_dict(data_item_data)
