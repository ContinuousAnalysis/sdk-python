...
T = TypeVar("T", bound="JobExecutionTaskList")


@_attrs_define
class JobExecutionTaskList:
    """Cursor-paginated list of an execution's tasks. Tasks are derived from event history; pagination slices the in-memory
    list and the cursor is a base64-JSON offset bound to (workspace, job, execution).

        Attributes:
            data (Union[Unset, list['JobExecutionTask']]): Page of execution tasks.
    ...
    data: Union[Unset, list["JobExecutionTask"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T | None:
        ...
        for data_item_data in _data or []:
            data_item = JobExecutionTask.from_dict(data_item_data)
