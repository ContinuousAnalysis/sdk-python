...
T = TypeVar("T", bound="SandboxList")


@_attrs_define
class SandboxList:
    """Cursor-paginated list of sandboxes. Returned starting with API version 2026-04-28; older API versions return a bare
    array.

        Attributes:
            data (Union[Unset, list['Sandbox']]): Page of sandboxes. Items use the lite shape (no inline event history) to
                keep the page payload small, matching the unpaginated response.
    ...
    data: Union[Unset, list["Sandbox"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T | None:
        ...
        for data_item_data in _data or []:
            data_item = Sandbox.from_dict(data_item_data)
