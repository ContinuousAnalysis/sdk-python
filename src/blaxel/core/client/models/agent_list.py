...
@_attrs_define
class AgentList:
    """Cursor-paginated list of agents. Returned starting with API version 2026-04-28; older API versions return a bare
    array of agents instead.

        Attributes:
            data (Union[Unset, list['Agent']]): Page of agents.
    ...
    data: Union[Unset, list["Agent"]] = UNSET
