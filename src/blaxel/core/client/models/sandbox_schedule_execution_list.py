...
if TYPE_CHECKING:
    ...
    from ..models.sandbox_schedule_execution import SandboxScheduleExecution


T = TypeVar("T", bound="SandboxScheduleExecutionList")


@_attrs_define
class SandboxScheduleExecutionList:
    """Cursor-paginated list of a sandbox's schedule execution history (across all its schedules).

    Attributes:
        data (Union[Unset, list['SandboxScheduleExecution']]): Page of schedule executions.
    ...
    data: Union[Unset, list["SandboxScheduleExecution"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T | None:
        ...
        for data_item_data in _data or []:
            data_item = SandboxScheduleExecution.from_dict(data_item_data)
        ...
        sandbox_schedule_execution_list = cls(
            data=data,
            meta=meta,
        )

        sandbox_schedule_execution_list.additional_properties = d
        return sandbox_schedule_execution_list
