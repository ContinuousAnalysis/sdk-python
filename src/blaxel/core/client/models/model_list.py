...
@_attrs_define
class ModelList:
    """Cursor-paginated list of model gateway endpoints. Returned starting with API version 2026-04-28; older API versions
    return a bare array.

        Attributes:
            data (Union[Unset, list['Model']]): Page of models.
    ...
    data: Union[Unset, list["Model"]] = UNSET
