...
def _parse_response(*, client: Client, response: httpx.Response) -> list["VPC"] | None:
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = VPC.from_dict(response_200_item_data)
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[list["VPC"]]:
    return Response(
